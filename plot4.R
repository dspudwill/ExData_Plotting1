...
##voltage plot
plot(power$Voltage ~ as.POSIXct.POSIXlt(power$date_time),
     data = power,
     type = "l", 
     ylab = "Voltage", 
     xlab = "datetime")
...
##Global Reactie Power Plot
plot(power$Global_reactive_power ~ as.POSIXct.POSIXlt(power$date_time),
     data = power,
     type = "l", 
     ylab = "Global Reactive Power", 
     xlab = "datetime")

##writing to plot4.png file
